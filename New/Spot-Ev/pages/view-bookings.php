...
$id = $_GET['id'];
$data = mysqli_query($con,"select * from bookings join login_tb on login_tb.login_id = bookings.user_id join user_register_tb on user_register_tb.login_id = login_tb.login_id where bookings.station_id = '$id' ");
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active "><a class="opacity-5 text-white"   href="Charging.php" aria-current="page"> Bookings</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"> View Bookings</li>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class=" align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">User</th>

                      <th class=" align-middle  text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Booking Date</th>

                      <th class=" align-middle  text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Amount</th>
...
while($row = mysqli_fetch_assoc($data)){
  $count++;
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $row['name'] ?></p>
                      </td>
                      <td>
                        <p class="align-middle  text-center text-xs font-weight-bold mb-0"><?php echo $row['date'] ?></p>
                      </td>
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $row['name'] ?></p>
                      </td>
