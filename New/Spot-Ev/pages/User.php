...
$data = mysqli_query($con,"select * from user_register_tb join login_tb on login_tb.login_id = user_register_tb.login_id");
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column ">
                            ...
                            <p class="text-xs text-secondary "><?php echo $dat['email'] ?></p>
                          </div>
                        </div>
                      </td>

                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $dat['mobile_no'] ?></span>
                      </td>
