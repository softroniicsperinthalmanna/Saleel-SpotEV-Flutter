...
$data = mysqli_query($con, "select * from station_tb");
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($data)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="view-bookings.php?id=<?php echo $row['station_id'] ?>"
                            class="btn btn-primary align-middle text-center text-xs font-weight-bold mb-0">View
                            Bookings</a>
                        </td>
