...
if ($image != "") {
    ...
    $data = mysqli_query($con,"insert into vehicles (brand,name,image) values('$brand','$name','$filenew')");
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Manage Vehicles</li>
          </ol>
        ...
        <div class="col-10">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Add Vehicles</h6>
              <a href="view-vehicles.php" class="btn btn-primary">View all vehicles</a>
            </div>
            <div class="card-body">
                  <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      <input type="text" name="name" class="form-control form-control-lg" placeholder="Model" aria-label="Model">
                    </div>
                  
                    <div class="mb-3">
                      <input type="file" name="pic" class="form-control form-control-lg" placeholder="Image" aria-label="Image">
                    </div>
                  
                    <a href="dashboard.php">
                    <div class="text-center">
                      <button name="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">ADD</button>
                    </div></a>
                  </form>
                </div>
