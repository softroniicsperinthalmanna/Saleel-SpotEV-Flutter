...
$data = mysqli_query($con, "SELECT * FROM offer INNER JOIN station_tb on offer.station_log_id=station_tb.login_id ");
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link active " href="../pages/Offer.php">
        <div
          class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="dashboard.php">OFFERS</a></li>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    while ($dat = mysqli_fetch_assoc($data)) {
                      ...
                      $filename = ($dat['image']);
                      $path = "http://localhost/New/SPOT_EV/image/$filename";
                      ?>
                      <tr>
                        <td>
