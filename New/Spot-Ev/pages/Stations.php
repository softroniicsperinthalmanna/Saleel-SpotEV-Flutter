...
$data = mysqli_query($con,"select * from station_tb join login_tb on login_tb.login_id = station_tb.login_id");
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link active " href="../pages/Stations.php">
        <div
          class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <!-- <th class="align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">Location</th> -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $dat['mobile_no']; ?></p>

                      </td>
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $dat['place']; ?></p>

                      </td>

                      <!-- <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $dat['location']; ?></span>
                      </td> -->
