...
$data = mysqli_query($con,"select * from review_tb");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="align-middle text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ">Reviews</th>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $row['user_id'] ?></p>
                      </td>
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $row['station_id'] ?></p>
                      </td>
                      <?php
                        if($row['rating']==0){
                          ?>
                     ...
                     ?>
                      <td>
                        <p class="align-middle text-center text-xs font-weight-bold mb-0"><?php echo $row['comment'] ?></p>
                      </td>
